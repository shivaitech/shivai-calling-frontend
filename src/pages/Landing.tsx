...
const handleAuth = async (e: React.FormEvent) => {
  ...
  // Static data
  const languages = [
    'English (US)', 'English (UK)', 'Hindi', 'Spanish', 'French', 'German', 
    'Chinese (Mandarin)', 'Japanese', 'Arabic', 'Portuguese', 'Italian', 'Dutch'
  ];
  
  const voices: Record<string, string[]> = {
    'English (US)': ['Sarah - Professional', 'Michael - Friendly', 'Emma - Warm'],
    'English (UK)': ['James - Sophisticated', 'Charlotte - Elegant', 'Oliver - Crisp'],
    'Hindi': ['Arjun - Friendly', 'Priya - Professional', 'Raj - Warm'],
    'Spanish': ['Carlos - Professional', 'Sofia - Friendly', 'Diego - Warm'],
    'French': ['Pierre - Sophisticated', 'Marie - Elegant', 'Antoine - Professional'],
    'German': ['Hans - Professional', 'Greta - Friendly', 'Klaus - Authoritative']
  };
  ...
  const testimonials = [
    {
      ...
      company: 'Stripe',
      content: "ShivAI's voice agents transformed our customer support. Integration took 5 minutes, and our customers love the natural phone conversations.",
      rating: 5,
      avatar: 'SC'
    },
    {
      ...
      company: 'Shopify',
      content: 'The voice integration was seamless. Our conversion rates increased 300% with natural voice interactions on our website.',
      rating: 5,
      avatar: 'MR'
    },
    {
      ...
      role: 'Founder & CEO',
      company: 'Razorpay',
      content: "One line of code gave us enterprise-grade voice AI. Our customers can't tell they're talking to AI - it's that natural.",
      rating: 5,
      avatar: 'PS'
    }
  ];
  ...
  const features = [
    {
      ...
      description: 'Advanced AI that understands context, emotions, and intent in real-time conversations.'
    },
    {
      icon: Code,
      title: 'One-Line Integration',
      description: 'Add voice capabilities to any platform with a single line of code. No complex setup required.'
    },
    {
      icon: Globe,
      title: 'Multi-Language Support',
      description: 'Support for 50+ languages and dialects with native-quality pronunciation.'
    },
    {
      icon: Shield,
      title: 'Enterprise Security',
      description: 'SOC 2 compliant with end-to-end encryption for all voice data and conversations.'
    },
    {
      icon: Brain,
      title: 'Smart Learning',
      description: 'AI agents learn from every conversation to provide increasingly better responses.'
    },
    {
      icon: Smartphone,
      title: 'Cross-Platform',
      description: 'Works seamlessly across web, mobile apps, phone systems, and IoT devices.'
    }
  ];
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12 border border-gray-100">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                  >
                    {(voices[selectedLanguage] || voices['English (US)']).map((voice) => (
              ...
              <div className="flex items-center justify-center">
                <div className="relative">
                  <div className={`w-64 h-64 rounded-full border-8 border-emerald-500 flex items-center justify-center transition-all duration-300 ${
                    isPlaying ? 'scale-110 border-emerald-400' : 'scale-100'
                  }`}>
                    <div className={`w-48 h-48 rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Powerful features that make implementing voice AI simple, scalable, and secure
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group hover:border-emerald-200">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Choose the perfect plan for your business. All plans include unlimited integrations and 24/7 support.
            </p>
            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="text-center mb-8">
                  <div className={`w-16 h-16 mx-auto rounded-xl bg-gradient-to-r from-${plan.color}-500 to-${plan.color}-600 flex items-center justify-center mb-4`}>
      ...
      <section id="customers" className="py-20 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See how companies are transforming their customer experience with ShivAI
            </p>
          </div>
