        ...
        <div className="flex flex-col xs:flex-row items-stretch xs:items-center gap-2 sm:gap-3 flex-shrink-0">
          <div className="relative">
            <select
              ...
              className="px-3 sm:px-4 py-2 bg-white/90 dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 text-sm appearance-none pr-10"
            >
          ...
          <button className="flex items-center justify-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm">
        ...
        <div className="xl:col-span-2">
          <GlassCard>
            <div className="p-4 sm:p-6">
              ...
              <div className="h-48 sm:h-64 flex items-end justify-between gap-0.5 sm:gap-1 overflow-x-auto">
                {callTimeline.map((item, index) => (
                  <div key={index} className="flex flex-col items-center group">
                    <div
                      className="w-2 sm:w-3 bg-gradient-to-t from-blue-500 to-blue-400 rounded-t hover:from-blue-600 hover:to-blue-500 transition-colors cursor-pointer"
                      style={{ height: `${(item.calls / maxCalls) * (window.innerWidth < 640 ? 150 : 200)}px` }}
                      title={`${item.hour}: ${item.calls} calls`}
                    ></div>
                    {index % (window.innerWidth < 640 ? 6 : 4) === 0 && (
          ...
          <div className="p-6">
            ...
            <div className="flex justify-center gap-6 mt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-slate-600 dark:text-slate-400">Success (233)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                <span className="text-sm text-slate-600 dark:text-slate-400">Failed (14)</span>
              </div>
            </div>
          </div>
        </GlassCard>
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-slate-50/50 dark:bg-slate-800/30 rounded-lg">
                ...
                <span className="font-semibold text-slate-800 dark:text-white">1.2s</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-slate-50/50 dark:bg-slate-800/30 rounded-lg">
                <span className="text-slate-600 dark:text-slate-400">Resolution Rate</span>
                <span className="font-semibold text-slate-800 dark:text-white">87.3%</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-slate-50/50 dark:bg-slate-800/30 rounded-lg">
                <span className="text-slate-600 dark:text-slate-400">Customer Satisfaction</span>
                <span className="font-semibold text-slate-800 dark:text-white">4.6/5</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-slate-50/50 dark:bg-slate-800/30 rounded-lg">
                <span className="text-slate-600 dark:text-slate-400">Escalation Rate</span>
                <span className="font-semibold text-slate-800 dark:text-white">3.2%</span>
              </div>
            </div>
          </div>
        </GlassCard>
            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 text-sm"
                />
              </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-200 dark:border-slate-700">
                  ...
                  <th className="text-left py-3 px-4 font-medium text-slate-600 dark:text-slate-400">Agent</th>
                  <th className="text-left py-3 px-4 font-medium text-slate-600 dark:text-slate-400">Caller</th>
                  <th className="text-left py-3 px-4 font-medium text-slate-600 dark:text-slate-400">Intent</th>
                  <th className="text-left py-3 px-4 font-medium text-slate-600 dark:text-slate-400">Outcome</th>
                  <th className="text-left py-3 px-4 font-medium text-slate-600 dark:text-slate-400">Duration</th>
                  <th className="text-left py-3 px-4 font-medium text-slate-600 dark:text-slate-400">Actions</th>
                </tr>
              </thead>
              <tbody>
                {recentConversations.map((conversation) => (
                  <tr key={conversation.id} className="border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50/50 dark:hover:bg-slate-800/30">
                    ...
                    <td className="py-3 px-4">
                      <button className="flex items-center gap-1 px-3 py-1 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors text-sm">
