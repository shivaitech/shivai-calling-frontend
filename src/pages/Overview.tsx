        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="block sm:hidden">
            <div className="flex gap-3 overflow-x-auto pb-2 no-scrollbar">
              <button 
                onClick={() => navigate('/agents/create')}
                className="flex-shrink-0 w-48 p-4 text-left bg-gradient-to-br from-blue-500/15 to-purple-500/15 hover:from-blue-500/25 hover:to-purple-500/25 rounded-xl transition-all duration-300 border border-blue-200/30 dark:border-blue-700/30 hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
              >
              ...
              <button 
                ...
                className="flex-shrink-0 w-48 p-4 text-left bg-gradient-to-br from-green-500/15 to-emerald-500/15 hover:from-green-500/25 hover:to-emerald-500/25 rounded-xl transition-all duration-300 border border-green-200/30 dark:border-green-700/30 hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
              >
                <div className="flex items-center gap-3 mb-2">
              ...
              <button 
                ...
                className="flex-shrink-0 w-48 p-4 text-left bg-gradient-to-br from-purple-500/15 to-pink-500/15 hover:from-purple-500/25 hover:to-pink-500/25 rounded-xl transition-all duration-300 border border-purple-200/30 dark:border-purple-700/30 hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
              >
                <div className="flex items-center gap-3 mb-2">
              ...
              <button 
                ...
                className="flex-shrink-0 w-48 p-4 text-left bg-gradient-to-br from-orange-500/15 to-red-500/15 hover:from-orange-500/25 hover:to-red-500/25 rounded-xl transition-all duration-300 border border-orange-200/30 dark:border-orange-700/30 hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]"
              >
                <div className="flex items-center gap-3 mb-2">
          ...
          <div className="hidden sm:grid grid-cols-2 lg:grid-cols-4 gap-4">
            <button 
              onClick={() => navigate('/agents/create')}
              className="p-4 text-left bg-gradient-to-br from-blue-500/10 to-purple-500/10 hover:from-blue-500/20 hover:to-purple-500/20 rounded-xl transition-all duration-300 border border-blue-200/20 dark:border-blue-700/20 hover:shadow-lg transform hover:scale-[1.02] group"
            >
            ...
            <button 
              onClick={() => navigate('/monitoring')}
              className="p-4 text-left bg-gradient-to-br from-green-500/10 to-emerald-500/10 hover:from-green-500/20 hover:to-emerald-500/20 rounded-xl transition-all duration-300 border border-green-200/20 dark:border-green-700/20 hover:shadow-lg transform hover:scale-[1.02] group"
            >
            ...
            <button 
              onClick={() => navigate('/training')}
              className="p-4 text-left bg-gradient-to-br from-orange-500/10 to-red-500/10 hover:from-orange-500/20 hover:to-red-500/20 rounded-xl transition-all duration-300 border border-orange-200/20 dark:border-orange-700/20 hover:shadow-lg transform hover:scale-[1.02] group"
            >
            ...
            <button 
              onClick={() => navigate('/settings')}
              className="p-4 text-left bg-gradient-to-br from-purple-500/10 to-pink-500/10 hover:from-purple-500/20 hover:to-pink-500/20 rounded-xl transition-all duration-300 border border-purple-200/20 dark:border-purple-700/20 hover:shadow-lg transform hover:scale-[1.02] group"
            >
