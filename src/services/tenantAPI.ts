...
const MOCK_TEMPLATES: PermissionTemplate[] = [
  { id: 'tpl-full', name: 'Full Access', grants: fullAccessGrants(true) },
  {
    ...
    grants: {
      ...
      'module:call-setup': true,
      'module:call-setup.page:inbound': true,
      'module:call-setup.page:outbound': true,
      'module:call-setup.page:outbound.action:launch-campaign': true,
      ...
      'module:marketplace.page:zoho': false,
      'module:marketplace.page:google-calendar': false,
