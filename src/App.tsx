              ...
              <div className="flex-1 min-w-0 lg:pl-64">
                ...
                <main className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 pt-20 sm:pt-24 min-w-0 max-w-full overflow-hidden">
                  <Routes>
                    ...
                    <Route path="/agents" element={<AgentManagement key="list" />} />
                    <Route path="/agents/create" element={<AgentManagement />} />
                    <Route path="/agents/:id" element={<AgentManagement />} />
                    <Route path="/agents/:id/edit" element={<AgentManagement />} />
