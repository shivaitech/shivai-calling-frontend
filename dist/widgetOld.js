(function () {
  ...
  function isAllowedDomain() {
    ...
    // BLOCK localhost for testing
    if (currentHostname === "localhost" || currentHostname === "127.0.0.1") {
      console.log("🚫 Widget blocked on localhost");
      return false;
    }
    ...
    // Block /MyAIEmployee routes, allow specific paths
    const isAllowedPath =
      currentPath === "/" ||
      currentPath === "/landing" ||
      currentPath === "/landing/" ||
  ...
  function convertFloat32ToPCM16(float32Array) {N
